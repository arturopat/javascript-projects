...
const hexPage = document.getElementById("hex__page");
const rgbPage = document.getElementById("rgb__page");
const hslPage = document.getElementById("hsl__page");

// selecting the main wrappers
const hexWrapper = document.getElementById("hex__wrapper");
const rgbWrapper = document.getElementById("rgb__wrapper");
const hslWrapper = document.getElementById("hsl__wrapper");

// selecting the buttons to change the background
const hexColor = document.getElementById("hex__color");
const rgbColor = document.getElementById("rgb__color");
const hslColor = document.getElementById("hsl__color");
